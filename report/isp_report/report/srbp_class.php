<?
	...
	class srbp
	{
		...
		{			
			...
			{
				$i++;
				$subTotal=$row["MonthlyFee"]+$row["MailBoxCharging"]+$row["UsageAmount"]+$row["CreditAllowance"]+$row["OtherAmount"];
				$Total=$row["MonthlyFee"]+$row["MailBoxCharging"]+$row["UsageAmount"]+$row["VAT"]+$row["CreditAllowance"]+$row["OtherAmount"];
