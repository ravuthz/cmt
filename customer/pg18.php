...
<script language="JavaScript" type="text/javascript">
	...
	function ValidateForm(){
		if(Trim(faddcontact.txtContactName.value) == ""){
			alert("Please enter contact name");
			faddcontact.txtContactName.focus();
			return;
			...
			alert("Please enter comment for add new customer contact");
...
<?php
	...
	//
	if(!empty($smt) && isset($smt) && ($smt == "savepg18")){
		...
		$sql = "INSERT INTO tblCustContact(CustID, ContactName, ContactNameKhmer, Salutation, DOB, Address, AddressKhmer, KhanID, SangkatID, CityID,
												CountryID, NationalityID, OccupationID, Phone, Email, IdentityMode, IdentityData, SignupDate)
									VALUES($CustomerID, '".$txtContactName."',".encodeUnicode($txtContactNameKhmer).", '".$selSalutation."', '".$txtDOB."', '".$txtAddress."', ".encodeUnicode($txtAddressKhmer).",
		...
		if($mydb->sql_query($sql)){
			...
			//$description = "add new customer contact as: Name: $selSalutation $txtContactName; DOB: $txtDOB; nationality: $txtNationality; occupation: $txtOccupation; phone: $txtPhone; email: $txtEmail; duplicate: $selDuplicateID- $txtDuplicate; address: $txtAddress; sangkat: $txtSangkat; Khan: $txtKhan; City: $txtCity; Country: $txtCountry.";
			$description = $comment;
			$audit->AddAudit($CustomerID, "", $title, $description, $Operator, 1, 7);
			$retOut = $myinfo->info("Successful added new customer contact");
			//redirect('./?CustomerID='.$CustomerID.'&pg=10');
		}else{
			$error = $mydb->sql_error();
			$retOut = $myinfo->error("Failed to add new customer contact.", $error['message']);
		}
	}
							...
							<td align="left" valign="top">
								<form name="faddcontact" method="post" action="./">
									<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
										<tr>
											<td align="left" class="formtitle" height="18"><b>Add new customer contact</b></td>
										</tr>
										<tr>
											<td valign="top">
												...
												<tr>
													...
													<td align="left" colspan="3">
														<input type="text" name="txtContactName" class="boxenabled" tabindex="43" size="82" value="<?php print $txtContactName;?>" />
													</td>
												</tr>
												<tr>
													<td align="left"><span class="khfont">ឈ្មោះ:</span></td>
													<td align="left" colspan="3">
														<input type="text" name="txtContactNameKhmer" class="boxenabled khfont" tabindex="43" size="82" value="<?php print $txtContactNameKhmer;?>" />
													</td>
												</tr>
												<tr>
													<td align="left" nowrap="nowrap">Date of birth:</td>
													<td align="left"><input type="text" tabindex="44" name="txtDOB" class="boxenabled" size="27" maxlength="30" value="<?php print formatDate($txtDOB, 5); ?>" onKeyUp="DateFormat(this,this.value,event,false,'2')" onBlur="DateFormat(this,this.value,event,true,'2')" />
													...
													<td align="left">
														<select name="selDuplicateID" class="boxenabled" tabindex="45">
															<option value="ID Card" <?php if($selDuplicateID == "ID Card") print "selected"?>>ID Card</option>
															<option value="Passport" <?php if($selDuplicateID == "Passport") print "selected"?>>Passport</option>
															<option value="Family book" <?php if($selDuplicateID == "Miss.") print "selected"?>>Family book</option>
														</select>
														<input type="text" name="txtDuplicate" class="boxenabled" tabindex="46" size="11" value="<?php print $txtDuplicate;?>" />
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td align="left"><input type="text" name="txtEmail" value=<?php print $ConEmail; ?>"" class="boxenabled" tabindex="50" size="29" /> </td>
												</tr>
												<tr>
													<td align="left">Address:</td>
													<td align="left" colspan="3">
														<input type="text" name="txtAddress" class="boxenabled" tabindex="51" size="83" maxlength="100" value="<?php print $txtConAddress; ?>" />
													</td>
												</tr>
												<tr>
													<td align="left"><span class="khfont">អាស័យដ្ឋាន:</span></td>
													<td align="left" colspan="3">
														<input type="text" name="txtAddressKhmer" class="boxenabled khfont" tabindex="51" size="83" maxlength="100" value="<?php print $txtConAddressKhmer; ?>" />
													</td>
												</tr>
													<tr>
														<tr>
									...
									<input type="hidden" name="pg" id="pg" value="18" />
									...
									<input type="hidden" name="smt" value="savepg18" />
								</form>
							</td>
						</tr>
					</table>
