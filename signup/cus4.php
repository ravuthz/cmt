									...
									<table border="0" cellpadding="2" cellspacing="0" width="100%" height="100%" bgcolor="#feeac2" align="left">													
										...
										<tr>
											...
											<td align="left">
												<?php
													if ($ServiceID==2)
													{
														$sql = "SELECT PackageID, TarName, CreatedDate, RegistrationFee, ConfigurationFee, CPEFee,
																		...
																		from tblTarPackage where Status = 1 and ServiceID = $ServiceID 
																		and DepositAmount<>1
																		order by 2";													
													}
													else
													{
														$sql = "SELECT PackageID, TarName, CreatedDate, RegistrationFee, ConfigurationFee, CPEFee,
																					ISDNFee, SpecialNumber
																		from tblTarPackage where Status = 1 and ServiceID = $ServiceID and DepositAmount<>1 order by 2";													
													}			
												...
												<select name="PackageID" tabindex="2">
