...
<script language="javascript" type="text/javascript">
	...
	function doReq(w){
				...
				url = "Load_Credit_Limit_SW_Usage_Online.php?&w="+w+"&mt=" + new Date().getTime();
	...
	function doIt(accID,Status,Amount,CycleID,Existing,Description,Inv,Done,curbook){
		...
		{
				url = "ins_switch_Credit_Limit_comment_usage.php?accID="+accID+"&Status="+Status+"&Amount="+Amount+"&CycleID="+CycleID+"&Existing="+Existing+"&curbook="+curbook+"&Done="+Done+"&dp="+new Date().getDate()+"&Description="+Description+"&mt=" + new Date().getTime();
				DoAction(url);
