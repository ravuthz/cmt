...
<?php
	...
	if(!empty($smt) && isset($smt) && ($smt == "savepg20")){
		...
		$sql = "INSERT INTO tblCustDesignate(CustID, DesignateName, Salutation, DOB, Address, KhanID, SangkatID, CityID, 
												CountryID, NationalityID, OccupationID, Phone, Email, IdentityMode, IdentityData, SignupDate)
									VALUES($CustomerID, '".$txtDesignate."', '".$selSalutation."', '".$txtDOB."', '".$txtAddress."',
