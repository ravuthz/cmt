	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			//		document.getElementById("d-invoice").innerHTML = loading;	
					document.getElementById("d-revenue").innerHTML = loading;																								
				...
				$retOut = '<table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
							<tr>
								<td align="left" class="formtitle">
									<b>Invoice issued from '.formatDate($st, 6).' and '.formatDate($et, 6).' for '.$sname.'</b>
								</td>
