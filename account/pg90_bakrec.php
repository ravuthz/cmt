...
<script language="javascript" type="text/javascript">
	...
	function doR(act,cID,aID,md,cst){
			...
			if($result = $mydb->sql_fetchrow($que)){				
				...
				switch($StatusID){
					case 0: #inactive
						...
						$stfg = $foreUnactivate;
						$stwd = "Inactive";
						$bl = "[<a href='#' onclick='javascript:doR(\"Activate\",".$CustomerID.",".$AccountID.",1,".$StatusID.");' >Activate</a>]";
						break;
					case 1: #active
						$stbg = $bgActivate;
						$stfg = $foreActivate;
						$stwd = "Active";						
						$bl = "[<a href='#' onclick='javascript:doR(\"Close\",".$CustomerID.",".$AccountID.",3,".$StatusID.");' >Close</a>]";
						break;
					case 2:	# Bar
						$stbg = $bgLock;
						$stfg = $foreLock;
					...
					case 4:	# close
						...
						$stfg = $foreClose;
						$stwd = "Closed";
						$bl = "[<a href='#' onclick='javascript:doR(\"Reconnect\",".$CustomerID.",".$AccountID.",0,".$StatusID.");' >Rec & Change</a>]";												
						break;
				}
				...
				$AcountUI.='
                                                                ...
                                                                <td align="left">';
                                                                        ...
                                                                        if($que){
                                                                            ...
                                                                            while($rst = $mydb->sql_fetchrow($que)){	
																				...
																				if($PackageID==$pID)
																				{
                                                                                	$tmppackage .= "<option value='".$PackageID."' selected>".$TarName."</option><br />";
																				}
																				else
																				{
							...
							$AcountUI.='                                    
                                                                    ...
                                                                    <select name="PackageID_'.$AccountID.'" tabindex="71">
                           ...
                           $AcountUI.='
															...
															<tr align="center">
																<td colspan="2">
																	<input type="button" name="Recon_'.$AccountID.'" value="Request" class="button" size="21" onClick="validateForm('.$AccountID.',\'Reconnect\','.$CustomerID.','.$AccountID.',0,'.$StatusID.')"/>
																</td>
															</tr>
                                                        </table>
                                                  </td>
