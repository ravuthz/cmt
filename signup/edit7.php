...
<script language="javascript">
	function storeNameValue(index, cat){		
		if(cat == 1){
			fedit7.txtIntSangkat.value = fedit7.selIntsSangkat.options[index].text;
		}	
		else if(cat == 2){			
			fedit7.txtIntKhan.value = fedit7.selIntKhan.options[index].text;
			location(4, fedit7.selIntKhan.options[index].value, "selIntSangkat");
		}
		else if(cat == 3){
			fedit7.txtIntCity.value = fedit7.selIntCity.options[index].text;						
			location(3, fedit7.selIntCity.options[index].value, "selIntKhan");
		}
		else if(cat == 4){
			fedit7.txtIntCountry.value = fedit7.selIntCountry.options[index].text;			
			location(2, fedit7.selIntCountry.options[index].value, "selIntCity");
		}				
	}
	
	function Validate(){
		fedit7.txtIntCountry.value = fedit7.selIntCountry.options[fedit7.selIntCountry.selectedIndex].text;
		fedit7.txtIntKhan.value = fedit7.selIntKhan.options[fedit7.selIntKhan.selectedIndex].text;
		fedit7.txtIntCity.value = fedit7.selIntCity.options[fedit7.selIntCity.selectedIndex].text;
		fedit7.txtIntSangkat.value = fedit7.selIntSangkat.options[fedit7.selIntSangkat.selectedIndex].text;
	...
	<tr>
		<td colspan="2" width="50%">
			<fieldset style="width:380px">
				<legend align="center">EDIT INSTALLATION ADDRESS</legend>
					<table border="0" cellpadding="2" cellspacing="0" width="100%" height="100%">								 																
						<tr>
								<td align="left">Address:</td>
								<td align="left" colspan="3">
									<input type="text" name="txtIntAddress" class="boxenabled" tabindex="1" size="73" maxlength="100" value="<?php print $txtIntAddress; ?>" />
								</td>
							</tr>										
							<tr>
								...
								<td align="left">
									<select name="selIntCity" class="boxenabled" tabindex="3" style="width:200px" onChange="storeNameValue(this.selectedIndex, 3);">	
										<option value="<?php print $selIntCity; ?>"><?php print $txtIntCity; ?></option>													
									</select>
								</td>										
							...
							<tr>
								...
								<td align="left">
									<select name="selIntKhan" class="boxenabled" tabindex="4" style="width:200px" onChange="storeNameValue(this.selectedIndex, 2);">
										<option value="<?php print $selIntKhan; ?>"><?php print $txtIntKhan; ?></option>																										
									</select>
								</td>
								...
								<td align="left">
									<select name="selIntSangkat" class="boxenabled" tabindex="5" style="width:200px" onChange="storeNameValue(this.selectedIndex, 1);">
										<option value="<?php print $selIntSangkat; ?>"><?php print $txtIntSangkat; ?></option>																										
									</select>
								</td>																					
							</tr>		
							<tr>
