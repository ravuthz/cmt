...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="0"  bordercolor="#000000" style=" border-collapse:collapse">
      <thead>
        <th width="3%"><div align="center" class="style9"><span class="style4">No</span></div></th>
        <th width="25%"><div align="center" class="style9"><span class="style4">Province</span></div></th>
        <th width="9%"><div align="center" class="style9"><span class="style4">Users</span></div></th>
        <th width="9%"><div align="center" class="style9"><span class="style4">Total hours </span></div></th>
        <th width="11%"><div align="center" class="style9"><span class="style4">Charging hour </span></div></th>
        <th width="7%"><div align="center" class="style9"><span class="style4">Monthly</span></div></th>
        <th width="6%"><div align="center" class="style9"><span class="style4">Box fee </span></div></th>
        <th width="9%"><div align="center" class="style9"><span class="style4">Usage Fee </span></div></th>
        <th width="9%"><div align="center" class="style9"><span class="style4">Sub total </span></div></th>
        <th width="6%"><div align="center" class="style9"><span class="style4">Vat</span></div></th>
        <th width="6%"><div align="center" class="style9"><span class="style4">Total</span></div></th>
      </thead>
	  <tbody>
      <?
