...
<script language="JavaScript" type="text/javascript">
	...
	function check(index){
		...
		for (iLoop = 0; iLoop < numinv; iLoop++){
			if(index == 1)
			{
				if(fpayinvoiceall.datecheck.value=="" || (fpayinvoiceall.datecheck.value==fpayinvoiceall.te[iLoop].value))
				{
				...
				fpayinvoiceall.i[iLoop].checked = 0;
		}
	}
	function submitIt(){
		CheckFrom = fpayinvoiceall.CheckFrom;
		CheckNumber = fpayinvoiceall.CheckNumber;
		ChequeDate = fpayinvoiceall.ChequeDate;
		if(CheckFrom.value == ""){
			...
			fpayinvoiceall.btns.disabled = true;
			fpayinvoiceall.submit();
		}
	}
...
<?php
	...
	# =============== Get customer header =====================
		...
		$mydb->sql_freeresult();
	if(!empty($smt) && isset($smt) && ($smt == "save58")){	
	/*	
		$i = 0;
			$totalPaid = 0.00;
                            ...
                            <form name="fpayinvoiceall" method="post" action="./">
								<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
									<tr>
										...
										<td align="right"><input type="text" name="datecheck" id="datecheck" value=""/>
									...
									<tr>
										<td colspan="2">
												...
												<table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" bgcolor="#feeac2" style="border-collapse:collapse" bordercolor="#999999">													
													...
													<?php
														$disabled = "disabled";
														$sql1 = "SELECT InvoiceID, InvoiceAmount, UnpaidAmount, AccID , CONVERT(varchar,s.billenddate,112) da
																		FROM tblCustomerInvoice c inner join tblSysBillRunCycleInfo s on c.BillingCycleID=s.CycleID
															...
															while($result1 = $mydb->sql_fetchrow($que1)){
																...
																if($que = $mydb->sql_query($sql)){
																	...
																	if(floatval($UnpaidAmount) > 0){ 
																		...
																		print '<tr>
																						<td>
																						<input type="text" name="t['.$iLoop.']" value="'.$da.'" id=te style="display:none;"/>
													...
													?>
													<tr>
														<td align="left" colspan="3">Cheque from:</td>
														<td align="left" colspan="3">
															<input type="text" name="CheckFrom" class="boxenabled" size="50" tabindex="4" />
														</td>
													</tr>
													<tr>
														<td align="left" colspan="3">Cheque number:</td>
														<td align="left" colspan="3">
															<input type="text" name="CheckNumber" class="boxenabled" size="50" tabindex="5" />
                                                            
														</td>
													</tr>
													<tr>
														<td align="left" nowrap="nowrap" colspan="3">Dated of issue:</td>
														<td align="left" colspan="3">
															<input type="text" name="ChequeDate" class="boxenabled" size="20" tabindex="6" onKeyUp="DateFormat(this,this.value,event,false,'2')" onBlur="DateFormat(this,this.value,event,true,'2')" />
															<button class="invisibleButtons" onClick="window.open( './javascript/calendar.html?fpayinvoiceall|ChequeDate', '', 'width=200,height=220,top=250,left=350');">
															<img src='./images/b_calendar.png' alt='View Calendar' align="middle" border="0" id="calenda">
														</button>									
														</td>
													</tr>
													...
													<td align="center" colspan="6">
														...
														<input type="button" tabindex="9" name="btns" value="Submit" class="button" <?php print $disabled; ?> onclick="submitIt();" />						
													</td>
												 </tr>
												 <?php
											...
											<input type="hidden" name="smt" value="save58" />
