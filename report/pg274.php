						...
						<table border="0" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
							...
							<tbody>
								<?php
										...
										$sql = " Select	InvoiceID, InvoiceAmount, UnpaidAmount, VATAmount, NetAmount, IssueDate, 
														AccID, UserName, StatusID, SubscriptionName																	
										...
										switch($id){
											case 1: # 0 - 30 days
													 $sql .= " and convert(varchar, BillEndDate, 112) > convert(varchar, dateadd(day, -30, getdate()), 112) ";																	
													break;
											case 2: # 30 - 60 days
													$sql .= " and convert(varchar, BillEndDate, 112) <= convert(varchar, dateadd(day, -30, getdate()), 112)
													...
													break;
											case 3: # 60 - 90 days
													$sql .= " and convert(varchar, BillEndDate, 112) <= convert(varchar, dateadd(day, -60, getdate()), 112)
															  and convert(varchar, BillEndDate, 112) > convert(varchar, dateadd(day, -90, getdate()), 112) ";
													break;
											case 4: # 90 - 120 days
													$sql .= " and convert(varchar, BillEndDate, 112) < convert(varchar, dateadd(day, -90, getdate()), 112)
															  and convert(varchar, BillEndDate, 112) >= convert(varchar, dateadd(day, -120, getdate()), 112) ";
													break;
											case 5: # > 120 days
													$sql .= " and convert(varchar, BillEndDate, 112) < convert(varchar, dateadd(day, -120, getdate()), 112) ";
													break;
										}
