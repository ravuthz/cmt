...
<script language="javascript" type="text/javascript">
	...
	function showReport(){
			...
			if(debtor.chkdbt.checked)
			{
					if (debtor.selService.options[debtor.selService.selectedIndex].value=="PHONE")
					{			
						url = "./php/lately_paid_f.php?&cid="+cid+"&w="+where;
					}
					else if (debtor.selService.options[debtor.selService.selectedIndex].value=="Lease Line")
					{			
						url = "./php/lately_paid_ll_f.php?&cid="+cid+"&w="+where;
					}
					else
					{
						url = "./php/lately_paid_isp_f.php?&cid="+cid+"&w="+where;
					}
			}
			else
			{
					if (debtor.selService.options[debtor.selService.selectedIndex].value=="PHONE")
					{			
						url = "./php/lately_paid.php?&cid="+cid+"&w="+where;
					}
					else if (debtor.selService.options[debtor.selService.selectedIndex].value=="Lease Line")
					{			
						url = "./php/lately_paid_ll.php?&cid="+cid+"&w="+where;
					}
					else
					{
						url = "./php/lately_paid_isp.php?&cid="+cid+"&w="+where;
					}
			}
			window.open(url);	
	...
	<tr>		
		<td valign="top" align="left">
			<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left">
				<tr>
					<td width="287" align="left" class="formtitle"><b>LIST OF LATELY PAID INVOICE</b></td>
						...
						<table border="0" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
							...
							<tr>								
								<td align="center" colspan="3">
									...
									<input type="checkbox" name="chkdbt" value="Early Month" /><font face="Arial, Helvetica, sans-serif" size="-3">Early Month</font>
								</td>
							</tr>
						</table>						
						</form>
