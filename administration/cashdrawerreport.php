...
<title>Close Drawer Report</title>
				...
				<tr>
					<td colspan="2">
							<table border="0" bordercolor="#999999" style="border-collapse:collapse" cellpadding="3" cellspacing="0" align="left" width="100%" bgcolor="#feeac2">																
							  ...
							  ?>
							  <tr>
							    <td colspan="4"> &nbsp;&nbsp;&nbsp;Date: <?php echo date("d M Y h:i:s")?></td>
						     </tr>
							  <tr>
...
cd.TransactionModeID in (1,3,4,5,6)
and isnull(cd.IsRollback,0)=0
group by cd.DrawerID order by TransactionName";
									$result=$mydb->sql_query($sql);
									$i=0;
...
group by 
DrawerID, TransactionModeID, TransactionName order by TransactionName";
									$result=$mydb->sql_query($sql);
									$i=0;
									$n=0;
									$totalother = 0;
	...
	<td>
		<table width="100%">
			<tr>
				<td align="left" width="36%"><b>Cashier:</b></td>
				<td align="left" width="37%"><b>Reported by:</b></td>
				<td align="left" width="33%"><b>Acknowledged By:</b></td>
			</tr>
		</table>
	</td>
	</tr>
	...
	<td>
		<table width="100%">
			<tr>
				<td align="left" width="36%"><b><?php echo $cashier;?></b><br />Cashier staff</td>
				<td align="left" width="37%"><b>Chea Khem</b><br />Cashier staff</td>
				<td align="left" width="33%"><b>Buth Boreivichet</b><br />Billing staff</td>
			</tr>
		</table>
	</td>
	</tr>
