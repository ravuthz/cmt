...
<script language="javascript" type="text/javascript">
	...
	function doReq(w,where){
				...
				url = "Load_Extra_SW_Usage_Online.php?&w="+w+"&where="+where+"&mt=" + new Date().getTime();
	...
	function doIt(accID,Status,Amount,CycleID,Existing,Description,Inv,Done,curbook){
		if(confirm("Are you sure to do this action."))	
		{
				url = "ins_switch_CS_comment_usage.php?accID="+accID+"&Status="+Status+"&Amount="+Amount+"&CycleID="+CycleID+"&Existing="+Existing+"&curbook="+curbook+"&Done="+Done+"&dp="+new Date().getDate()+"&Description="+Description+"&mt=" + new Date().getTime();
				DoAction(url);
