...
//			$mydb->sql_query($sql);
		...
		if($addaudit){
				$Audit = new Audit();				
				$Audit->AddAudit($CustomerID, $AccountID, "Confirm pending request for MDF", $Description, $user['FullName'], 1, 6);
		}
	}
?>
	...
	<tr>		
		<td valign="top" align="left">
			<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
				<tr>
					<td align="left" class="formtitle"><b>MDF REPORT</b></td>
					<td align="right"></td>
				</tr> 
				<tr>
					<td colspan="2">
						<table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
							<thead>																	
								...
								<th>Register Date</th>	
								<th>Sale Comment</th>
								<th>SW/ISP Comment</th>
								<th>Done</th>																						
							</thead>
							<tbody>
								<?php
										$sql = "SELECT j.JobID, j.AccID, j.CurrentStatusID, j.NewStatusID, j.SubmitDate, 
															j.EffectiveDate, j.comment 'SaleComment', j.ISPComment, j.SWComment, j.Incoming, j.Outgoing, j.International, j.IncomingLoc,j.IncomingNat, j.OutgoingLoc, j.OutgoingNat, j.Other,a.CustID, a.UserName,tp.tarName, left(a.subscriptionName,30) 'SubName'
														FROM tblJobAcctStatus j, tblCustProduct a, tblTarPackage tp
														WHERE j.AccID = a.AccID and a.packageid = tp.packageid and MDFDone = 0 and j.ISPDone = 1 
...
//											$StatusID = intval($result['StatusID']);
											...
											if(is_null($ISPComment) || ($ISPComment == "")) 
												$Comment = $SWComment;
											else
												$Comment = $ISPComment;
						...
						<form name="fdoneit" method="post" action="./">
							...
							<input type="hidden" name="pg" value="270" />
						</form>
					</td>
				</tr>
			</table>
