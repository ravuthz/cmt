...
<?php
	...
	*/
	$Audit=new Audit();
	if(isset($smt) && (!empty($smt)) && ($pg == 1007)){
...
<script language="javascript">
	function ActionConfirmation(id, code){
		if(confirm("Do you want to delete time band: " + code + "?"))
			window.location = "./?pg=1007&op=deactivate&timeid=" + id;
	}
	...
	function Reset(){
		document.location.href="./?pg=1007";
	}
...
<table border="0" cellpadding="2" cellspacing="0" class="formbg"  width="522">
			  ...
			  <input type="hidden" name="pg" id="pg" value="1007">
