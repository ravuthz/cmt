...
<script language="JavaScript" type="text/javascript">
	...
	function ChangePayment(index){
		...
		if(faddcredit.selPaymentID.options[index].text == "Cheque"){
			faddcredit.CheckFrom.disabled = false;
			faddcredit.CheckNumber.disabled = false;
			faddcredit.ChequeDate.disabled = false;
			faddcredit.CheckFrom.className = "boxenabled";
			faddcredit.CheckNumber.className = "boxenabled";
			faddcredit.ChequeDate.className = "boxenabled";
			theCalendar.style.display = "block";
		}else{
			faddcredit.CheckFrom.disabled = true;
			faddcredit.CheckNumber.disabled = true;
			faddcredit.ChequeDate.disabled = true;
			faddcredit.CheckFrom.className = "boxdisabled";
			faddcredit.CheckNumber.className = "boxdisabled";
			faddcredit.ChequeDate.className = "boxdisabled";
			theCalendar.style.display = "none";
		}
	}
	function submitForm(){
		Amount = faddcredit.Amount;
		PaymentID = faddcredit.selPaymentID;
		CheckFrom = faddcredit.CheckFrom;
		CheckNumber = faddcredit.CheckNumber;
		ChequeDate = faddcredit.ChequeDate;
		Description = faddcredit.Description;
		...
		faddcredit.btnSubmit.disabled = true;
		faddcredit.submit();
	}
</script>
<?php
	...
	if(!empty($smt) && isset($smt) && ($smt == "save")){
		...
		if($DrawerID == 0){
			$retOut = $myinfo->warning("Failed to increase credit. No cash drawer open for cashier ".$user["FullName"]);
		}else{;
			...
			if($retOut){				
				$Description = "Increase credit ".FormatCurrency($Amount)."- $Description";
				$Audit->AddAudit($CustomerID, $AccountID, "Increase credit", $Description, "", 1, 4);
						...
						<tr>
							...
							<td valign="top" align="left">
								<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
									<tr>
										<td align="left" class="formtitle"><b>INCREASE BALANCE</b></td>
										<td align="right">&nbsp;											
										</td>
									</tr> 				
									<tr>
										<td colspan="2">
											<form name="faddcredit" method="get" action="./" onSubmit="return false;">
												<table border="0" cellpadding="3" cellspacing="0" align="center" width="100%" bgcolor="#feeac2">																
													<tr>
														<td align="left">Account:</td>
														<td align="left">
															<select name="AccountID" class="boxenabled" tabindex="1">																				
																<?php
													...
													<tr>
														<td align="left" nowrap="nowrap">Increase amount:</td>
													...
													<tr>
														...
														<td align="left">
															<input type="text" name="CheckFrom" class="boxdisabled" size="50" tabindex="4" disabled="disabled" />
														</td>
													</tr>
													<tr>
														<td align="left">Cheque number:</td>
														<td align="left">
															<input type="text" name="CheckNumber" class="boxdisabled" size="50" tabindex="5" disabled="disabled" />
														</td>
													</tr>
													<tr>
											...
											<input type="hidden" name="pg" value="48" />
