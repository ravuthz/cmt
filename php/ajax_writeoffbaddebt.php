<?php
	...
	$retOut = '<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
				<tr>
					<td align="left" class="formtitle">
						<b>&nbsp;Write Off Bad Debt - from '.formatDate($st, 6).' and '.formatDate($et, 6).'</b>
					</td>
					<td align="right"></td>
				</tr> 
				<tr>
	...
	$sql = "
			...
			p.PaymentAmount, p.PaymentDate, p.Cashier
	...
	if($que = $mydb->sql_query($sql)){		
		...
		while($result = $mydb->sql_fetchrow()){																															
			...
			$retOut .= '<td class="'.$style.'" align="left">$'.$PaymentAmount.'</td>';
