...
<script language="javascript">
	...
	function ValidateForm(){
		...
		SelPhonePreset = fsignupcust4.SelPhonePreset.options[fsignupcust4.SelPhonePreset.selectedIndex].value;
		UserName = fsignupcust4.UserName;
...
//================================== international call deposit
		...
		fsignupcust4.txtCPE.value = fsignupcust4.CPETypeID.options[fsignupcust4.CPETypeID.selectedIndex].text;
		fsignupcust4.txtAccountName.value = SelPhonePreset+UserName.value;
	...
	function ValidAccount(retDiv){
		phonepre = fsignupcust4.SelPhonePreset.options[fsignupcust4.SelPhonePreset.selectedIndex].value;
		phonenum = fsignupcust4.UserName.value;
									...
									<table border="0" cellpadding="2" cellspacing="0" width="100%" height="100%" bgcolor="#feeac2" align="left">													
										...
										<tr>
											...
											<td align="left">
												...
												<input type="checkbox" name="vatRegistrationFee" checked="checked" value="1" />Charge VAT
											</td>
										</tr>		
										<tr>
											...
											<td align="left">
												...
												<input type="checkbox" name="vatConfigurationFee" checked="checked" value="1" />Charge VAT
											</td>
										</tr>		
										<tr>
											...
											<td align="left">
												...
												<input type="checkbox" name="vatCPEFee" checked="checked" value="1" />Charge VAT
											</td>
										</tr>
										<tr>
											<td align="left" nowrap="nowrap">ISDN Cost:</td>
											<td align="left">
												<input type="text" name="ISDNFee" value="0" class="boxenabled" tabindex="6" size="30" />
												<input type="checkbox" name="vatISDNFee" checked="checked" value="1" />Charge VAT
											</td>
										</tr>
										<tr>
											<td align="left" nowrap="nowrap">Special Number Cost:</td>
											<td align="left">
												<input type="text" name="SPNFee" value="0" class="boxenabled" tabindex="7" size="30" />
												<input type="checkbox" name="vatSPNFee" checked="checked" value="1" />Charge VAT
											</td>
										</tr>										
										<tr>
										...
										<tr>
											<td colspan="2" width="50%">
												<fieldset style="width:380px">
													<legend align="center">DEPOSIT</legend>
													<table border="0" cellpadding="3" cellspacing="0" align="left">
														<tr>
															<td align="left">National Call Deposit:</td>
															<td align="left">
																<input type="checkbox" name="chkncDeposit" value="1" tabindex="14" onclick="chk(1)" />&nbsp;
																<input type="text" name="ncDeposit" value="" disabled="disabled" class="boxdisabled" tabindex="15" />
															</td>
														</tr>
														<tr>
															<td align="left">International Call Deposit:</td>
															<td align="left">
																<input type="checkbox" name="chkicDeposit" value="1" tabindex="16" onclick="chk(2)" />&nbsp;
																<input type="text" name="icDeposit" value="" disabled="disabled" class="boxdisabled" tabindex="17" />
															</td>
														</tr>
														<tr>
															<td align="left">Monthly Fee Deposit:</td>
															<td align="left">
																<input type="checkbox" name="chkmfDeposit" value="1" tabindex="18" onclick="chk(3)" />&nbsp;
																<input type="text" name="mfDeposit" value="" disabled="disabled" class="boxdisabled" tabindex="18" />
															</td> 
														</tr>
													</table>
												</fieldset>
