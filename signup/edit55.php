...
<script language="javascript">
	...
	function ValidAccount(retDiv){
		username = fedit5.txtAccountName.value;		
		domain = fedit5.domain.value;
	...
	function ValidateForm(){
		...
		txtAccountName = fedit5.txtAccountName;
...
//		}
		...
		fedit5.txtAccountName.value = txtAccountName.value + domain;
				...
				<legend align="center">EDIT ACCOUNT INFORMATION</legend>
					<table border="0" cellpadding="2" cellspacing="0" width="100%" height="100%" align="left">													
						...
						<tr>
							...
							<td align="left"><input type="text" name="mfDeposit" value="0" class="boxenabled" tabindex="18" size="30" /></td>
						</tr>								
						<tr>
							<td align="left" nowrap="nowrap">Registration fee:</td>
							<td align="left">
								<input type="text" name="RegistrationFee" value="<?php print $RegistrationFee; ?>" class="boxenabled" tabindex="3" size="30" /> 
								<input type="checkbox" name="vatRegistrationFee" <?php if(intval($vatRegistrationFee) ==1) print 'checked="checked"'; ?> value="1" />Charge VAT
							</td>
						</tr>		
						<tr>
							<td align="left" nowrap="nowrap">Installation fee:</td>
							<td align="left">
								<input type="text" name="ConfigurationFee" value="<?php print $ConfigurationFee; ?>" class="boxenabled" tabindex="4" size="30" /> 
								<input type="checkbox" name="vatConfigurationFee" <?php if(intval($vatConfigurationFee) ==1) print 'checked="checked"'; ?> value="1" />Charge VAT
							</td>
						</tr>		
						<tr>
							<td align="left" nowrap="nowrap">CPE cost:</td>
							<td align="left">
								<input type="text" name="CPEFee" value="<?php print $CPEFee; ?>" class="boxenabled" tabindex="5" size="30" /> 
								<input type="checkbox" name="vatCPEFee" <?php if(intval($vatCPEFee) ==1) print 'checked="checked"'; ?> value="1" />Charge VAT
							</td>
						</tr>															
						<tr>
										...
										if($que){
											while($rst = $mydb->sql_fetchrow($que)){	
												...
												if($CPETypeID == $CPEID) 
													...
													$sel = "";															
												print "<option value='".$CPEID."' ".$sel.">".$CPEName."</option>";
											}
										}
										$mydb->sql_freeresult();
									?>
						...
						<tr>
							...
							<td align="left">
								...
								<input type="text" name="txtAccountName" id="txtAccountName" value="<?php print ereg_replace("@camintel", "", $txtAccountName);?>"  class="boxenabled" tabindex="10" size="30" onblur="ValidAccount('dUserName');" maxlength="7" /><img src="./images/required.gif" border="0" /><span style="display:none" id="dUserName" class="error"></span>
							</td>
						</tr>
						<tr>
...
<input type="hidden" name="SPNFee" value="<?php print $SPNFee; ?>" class="boxenabled" tabindex="7" size="30" /> 
<input type="hidden" name="ISDNFee" value="<?php print $ISDNFee; ?>" class="boxenabled" tabindex="6" size="30" />
