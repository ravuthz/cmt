<?php
	...
	$retOut = '<table border="0" cellpadding="3" cellspacing="0" class="formbg" align="center" width="100%">
				<tr>
				    ...
				    <td width="24%" align="right" class="formtitle">[<a href="./export/closed_drawer_report.php?st='.$st.'&et='.$et.'&type=csv">Download</a>]</td>
				</tr>
				<tr>
					<td colspan="2">
	...
	$sql = "select t.TransactionName, sum(p.PaymentAmount) as 'Amount' 
					from tblCashPayment p, tlkpTransaction t
