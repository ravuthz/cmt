							...
							<tbody>
								<?php
										$sql = "SELECT j.JobID, j.AccID, j.CurrentStatusID, j.NewStatusID, j.SubmitDate, 
															j.EffectiveDate, j.SWComment, j.Incoming, j.Outgoing, j.International, j.IncomingLoc,
															j.IncomingNat, j.OutgoingLoc, j.OutgoingNat, j.Other,	a.CustID, a.UserName
														FROM tblJobAcctStatus j, tblCustProduct a
														WHERE j.AccID = a.AccID and j.IsConfirm = 1 and MDFDone = 0 and j.OpDone = 0 and j.IsDone = 0 ORDER BY j.EffectiveDate,  j.JobID";
