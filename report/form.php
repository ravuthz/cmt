...
<table border="1" cellpadding="3" cellspacing="0" width="100%" bordercolor="#000000" style="border-collapse:collapse">
	<tr>
		<td colspan="2" bgcolor="#999999" align="center">
			<font color="#FFFFFF"><b>Application Form<br /></b></font>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			<table border="0" cellpadding="3" cellspacing="0" align="left">
				<tr>
					<td align="left" nowrap="nowrap">From Installation Address:</td>
					<td align="left" width="40%"><b><?php print $installAddress;?></b></td>
					<td align="left" nowrap="nowrap">Contact name:</td>
					<td align="left" width="40%"><b><?php print $ContactName;?></b></td>					
				</tr>
				<tr>
					<td align="left" nowrap="nowrap">To Installation Address:</td>
				...
				<tr>
					...
					<td align="left" width="40%"><?php print $Address;?></td>
					<td align="left" nowrap="nowrap">Address:</td>
					<td align="left" colspan="3"><?php print $conAddress;?></td>					
				</tr>			
				<tr>
					<td align="left" nowrap="nowrap">Telephone number:</td>
					<td align="left" width="40%"><b><?php print $AccountName;?></b></td>
				...
				<tr>
					...
					<td align="left" width="40%"><b><?php print FormatCurrency($CycleFee);?></b></td>
				</tr>	
			</table>
		</td>
	</tr>	
