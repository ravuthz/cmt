...
{
	print "<h3>mssql</h3>";
	$db = mssql_connect('SAOSOTHON\\SQLEXPRESS','sa','admin') or die('No Connection');
...
include_once('DB.php');
	...
	$username = 'sa';
	$password = 'admin';
	$hostname = 'SAOSOTHON\\SQLEXPRESS';
	$databasename = 'MyFootball';
...
include_once('../adodb.inc.php');
	...
	$conn->Connect('SAOSOTHON\\SQLEXPRESS','sa','admin','MyFootball');
//	$conn->debug=1;
	print "date=".$conn->GetOne('select getdate()')."<br>";
