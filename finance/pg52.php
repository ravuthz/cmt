...
<script language="JavaScript" type="text/javascript">
	...
	loading = "<table width='100%' height='100%' border=0 cellspacing=0 cellpadding=100><tr><td align=center><p><img src='./images/loading.gif' border=0><br><b>Please wait a moment...</b></p></td></tr></table>";
			document.getElementById("d-refund").innerHTML = loading;
			url = "./php/ajax_refund.php?cid="+cid+"&acc="+acc+"&mt="+new Date().getTime();
			getTranDetail(url, "d-refund");
						...
						<tr>
							...
							<td valign="top" align="left">
								<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
									<tr>
										<td align="left" class="formtitle"><b>REFUND HISTORY</b></td>
										<td align="right">
										...
										<div id="d-refund">
											<table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
												...
												<tbody>
													<?php
														$Finance = new Payment();
														$que = $Finance->GetRefundHistory($CustomerID);
														$iLoop = 1;
														$Total = 0;
														while($result = $mydb->sql_fetchrow()){
															...
															$Receipt = "<a href='./Receipt.php?CustomerID=".$CustomerID."&PaymentID=".$PaymentID."'>".$PaymentID."</a>";
															$Type = "DN";
															$iLoop++;
															...
															print '<td class="'.$style.'" align="left">'.$Type.'</td>';
															print '<td class="'.$style.'" align="left">'.$UserName.'</td>';
															print '<td class="'.$style.'" align="left">'.formatDate($PaymentDate, 3).'</td>';
