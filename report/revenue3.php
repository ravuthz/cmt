	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			//		document.getElementById("d-invoice").innerHTML = loading;	
					document.getElementById("d-revenuedetail").innerHTML = loading;																								
																				
					// Invoice summary ===================					
					
					url3 = "../php/ajax_revenue6.php?st="+st+"&et="+et+"&service="+service+"&mt="+ new Date().getTime();
					getTranDetail(url3, "d-revenuedetail");	
				...
				$retOut = '<table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
							<tr>
								<td align="left" class="formtitle">
									<b>TOTAL DAILY DEPOSIT,PRE-PAYMENT, REFUND, TRANSFER AND SETTLE PAYMENT REPORT</b><br>
									Service: '.$sname.'<br> 
