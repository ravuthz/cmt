				...
				<tr>
					<td colspan="2">						
						<table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" style="border-collapse:collapse" bordercolor="#aaaaaa" bgcolor="#eeeeee">							
							...
							<tr>
								<td colspan="2" bgcolor="#aaaaaa">ISP</td>
							</tr>
							<tr>
								<td align="left">ISP done: </td>
								<td align="left"><?php print $IsISP; ?></td>
							</tr>
							<tr>
								<td align="left">ISP done date: </td>
								<td align="left"><?php   print FormatDate($ISPDoneDate, 6); ?></td>
							</tr>
							<tr>
								<td align="left" valign="top">ISP comment: </td>
								<td align="left"><?php print $ISPComment; ?></td>
							</tr>
							<tr>
