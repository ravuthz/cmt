...
<script language="JavaScript" type="text/javascript">
	...
	function ValidateForm(){
		if(Trim(faddcontact.txtDesignate.value) == ""){
			alert("Please enter designate name");
			faddcontact.txtDesignate.focus();
			return;
			...
			alert("Please enter comment for add new customer designate");
...
<?php
	...
	//
	if(!empty($smt) && isset($smt) && ($smt == "savepg20")){
		...
		$sql = "INSERT INTO tblCustDesignate(CustID, DesignateName, DesignateNameKhmer, Salutation, DOB, Address, AddressKhmer, KhanID, SangkatID, CityID,
												CountryID, NationalityID, OccupationID, Phone, Email, IdentityMode, IdentityData, SignupDate)
									VALUES($CustomerID, '".$txtDesignate."', ".encodeUnicode($txtDesignateKhmer).", '".$selSalutation."', '".$txtDOB."', '".$txtAddress."', ".encodeUnicode($txtAddressKhmer).",
		...
		if($mydb->sql_query($sql)){
			...
			//$description = "add new customer designate as: Name: $selSalutation $txtDesignate; DOB: $txtDOB; nationality: $txtNationality; occupation: $txtOccupation; phone: $txtPhone; email: $txtEmail; duplicate: $selDuplicateID- $txtDuplicate; address: $txtAddress; sangkat: $txtSangkat; Khan: $txtKhan; City: $txtCity; Country: $txtCountry.";
			$description = $comment;
			$audit->AddAudit($CustomerID, "", $title, $description, $Operator, 1, 7);
			//redirect('./?CustomerID='.$CustomerID.'&pg=10');
			$retOut = $myinfo->info("Successful add new customer designate");
		}else{
			$error = $mydb->sql_error();
			$retOut = $myinfo->error("Failed to add new customer designate.", $error['message']);
		}
	}
							...
							<td align="left" valign="top">
								<form name="faddcontact" method="post" action="./">
									<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
										<tr>
											<td align="left" class="formtitle" height="18"><b>Add new customer designate</b></td>
										</tr>
										<tr>
											<td valign="top">
												...
												<tr>
													...
													<td align="left" colspan="3">
														<input type="text" name="txtDesignate" class="boxenabled" tabindex="43" size="82" value="<?php print $txtDesignate;?>" />
													</td>
												</tr>
												<tr>
													<td align="left"><span class="khfont">ឈ្មោះ:</span></td>
													<td align="left" colspan="3">
														<input type="text" name="txtDesignateKhmer" class="boxenabled khfont" tabindex="43" size="82" value="<?php print $txtDesignateKhmer;?>" />
													</td>
												</tr>
												<tr>
									...
									<input type="hidden" name="pg" id="pg" value="20" />
									...
									<input type="hidden" name="smt" value="savepg20" />
								</form>
							</td>
						</tr>
					</table>
