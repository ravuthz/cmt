						...
						<tr>
							...
							<td valign="top" align="left">
								<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
									<tr>
										<td align="left" class="formtitle"><b>Customer Application Form 
									...
									<tr>
										<td colspan="2">
											<table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
												...
												<tbody>
													<?php
														$sql = "select URL 'Form' from tblreportlist
																where reportTypeID = 2 and Name like '$AccountID%'";
														if($que = $mydb->sql_query($sql)){
															while($result = $mydb->sql_fetchrow()){
																$Form = $result['Form'];
															}	
														$sql = "select URL 'Map' from tblreportlist
																where reportTypeID = 1 and Name like '$AccountID%'";
														if($que = $mydb->sql_query($sql)){
															while($result = $mydb->sql_fetchrow()){
																$Map = $result['Map'];
															}	
																...
																print '</tr>';
																print '<tr>';
																print '<td class="'.$style.'" align="center"><a href=./report/extra/'.$Form.' target=_blank>Print Scan Application Form</a></td>';

																print '<td class="'.$style.'" align="center"><a href=./report/extra/'.$Map.' target=_blank>Print Customer Map</a></td>';
																print '</tr>';
																print '<tr>';	
																print '<td colspan="2" align="center"><a href=./report/form.php?AccountID='.$AccountID.' target=_blank>Print System Application Form</a></td>';
																print '</tr>';
															}
														}
														$mydb->sql_freeresult();	
