...
$sql = "		select s.Menu, s.URL
				...
				and s.PageCode In (	
									select p.PageCode from tblSecPage p join tblSecUserPage up on up.PageID = p.PageID and up.UserID = ".$user["userid"]."
									Union
									Select p.PageCode
									from tblSecPage p join tblSecGroupPage gp on gp.PageID=p.PageID 
									join tblSecUserGroup ug on ug.GroupID = gp.GroupID
