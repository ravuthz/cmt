...
<script language="JavaScript" type="text/javascript">
	...
	loading = "<table width='100%' height='100%' border=0 cellspacing=0 cellpadding=100><tr><td align=center><p><img src='./images/loading.gif' border=0><br><b>Please wait a moment...</b></p></td></tr></table>";
			...
			url = "./php/ajax_unpaidinvoice.php?cid="+cid+"&acc="+acc+"&mt="+new Date().getTime();
						...
						<tr>
							...
							<td valign="top" align="left">
								<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
									<tr>
										<td align="left" class="formtitle" nowrap="nowrap"><b>UNPAID INVOICES</b> [Pay all <a href="./?CustomerID=<?php print $CustomerID;?>&pg=57">(Cash)</a> | <a href="./?CustomerID=<?php print $CustomerID;?>&pg=58">(Cheque)</a>] </td>
										<td align="right">
											<form name="funpaidinvoice" onsubmit="getInvoice(); return false;">
											...
											<div id="d-unpaidinvoice">
												<table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
													...
													<tbody>
														<?php
															$Finance = new Invoice();
															$que = $Finance->GetDepositInvoice($CustomerID);
															$iLoop = 1;
															$Total = 0;
															$Unpaid = 0;
															while($result = $mydb->sql_fetchrow()){
																...
																$print = "<a href='javascript:doPrint(".$InvoiceID.", ".$CustomerID.");'><img src='./images/fileprint.gif' border='0'>";
																$iLoop++;
																$Total += floatval($InvoiceAmount);
																$Unpaid += floatval($UnpaidAmount); 
																if(($iLoop % 2) == 0)
																	$style = "row2";
																else
																	$style = "row1";
																...
																print '<td class="'.$style.'" align="right">'.formatDate($DueDate, 1).'</td>';
																print '<td class="'.$style.'" align="left">'.$Reminder.'</td>';
																print '<td class="'.$style.'" align="right">'.FormatCurrency($InvoiceAmount).'</td>';
																print '<td class="'.$style.'" align="right">'.FormatCurrency($UnpaidAmount).'</td>';	
																print '<td class="'.$style.'" align="left">'.$link.'</td>';
																//print '<td class="'.$style.'" align="left">'.$print.'</td>';
																print '</tr>';
															}
															$mydb->sql_freeresult();	
														?>
													...
													<tfoot>
														...
														<td align="right"><?php print FormatCurrency($Unpaid);?></td>
														<td>&nbsp;</td>
														</tr>
													</tfoot>	
												</table>
