...
<?php
	...
	if(!empty($smt) && isset($smt) && ($smt == "savepg17")){
		...
		$sql = "UPDATE tblCustGuarrantor SET
							...
							GuarrantorNameKhmer = ".encodeUnicode($txtGuarrantorKhmer).",
	...
	$sql = "select GuarrantorName, Salutation, DOB, Address, SangkatID, KhanID, CityID, CountryID,
			...
			convert(varbinary(500), GuarrantorNameKhmer) AS GuarrantorNameKhmer,
	...
	if($que = $mydb->sql_query($sql)){
		if($rst = $mydb->sql_fetchrow($que)){
			...
			$GuarrantorNameKhmer = $rst['GuarrantorNameKhmer'];
											...
											<td valign="top">
												<table border="0" cellpadding="2" cellspacing="0" width="100%" height="100%" bgcolor="#feeac2">
													...
													<tr>
														...
														<td align="left" colspan="3">
															<input type="text" name="txtGuarrantorKhmer" class="boxenabled khfont" size="83" maxlength="50" value="<?php print decodeUnicode($GuarrantorNameKhmer);?>" />
														</td>
													</tr>
													<tr>
