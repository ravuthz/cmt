...
echo '		
												  ...
												  echo "<td class='".$rowclass."' ><a href=\"?pg=1101&amp;op=edit&amp;hid=".$ID."\"><img src='./images/Edit.gif' border='0'></a>&nbsp;<a href=\"javascript:ActionConfirmation(".$ID.","."'".addslashes($RuleName)."'".")\"><img src=\"./images/Delete.gif\" border=\"0\"></a></td>";
													echo '</tr>';																
													}
													if(HasCreditRuleInvoiceDetail($ID)){
