				...
				<tr>
					<td>
						...
						<table border="0" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#aaaaaa">
							...
							<tr>
								<td colspan="2">
									<input type="radio" name="fType" value="1" checked="checked" />Report&nbsp;&nbsp;
									<input type="radio" name="fType" value="2" />Announcement&nbsp;&nbsp;
									<input type="radio" name="fType" value="3" />Other&nbsp;&nbsp;
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td align="left"><input type="button" name="btnSubmit" value="Upload" tabindex="4" onClick="upload();" /></td>
							</tr>
						</table>
