...
<?php
	...
	$retOutH='<br><br><table border="1" cellpadding="3" cellspacing="0" align="center" width="100%" height="100%" id="audit3" class="sortable" style="border-collapse:collapse" bordercolor="#cccccc">
							...
							<thead>																									
								...
								<th align="center" width="9%" style="border-left:1px solid #999999; border-top:1px solid #999999;" nowrape>Customer Name</th>
								<th align="center" width="5%" style="border-left:1px solid #999999; border-top:1px solid #999999;">Deposit</th>
								...
								<th align="center" width="7%" style="border-left:1px solid #999999; border-top:1px solid #999999;" nowrape>Telephone</th>
								<th align="center" width="11%" style="border-left:1px solid #999999; border-top:1px solid #999999;" nowrape>Payment Date</th>
	...
	$sql = "select * from dbo.fn_latelypaid_1m_isp('".$cid."','".$where."') order by remark desc,exception,state,del ,phone,CustName";
