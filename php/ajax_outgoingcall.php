<?php
	...
	$retOut = '<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" width="100%">
				<tr>
					...
					<td align="right">
						[<a href="./report/outgoingcall.php?st='.$st.'&et='.$et.'&pid='.$pid.'&did='.$did.'" target="_blank">Print</a>]&nbsp;
						[<a href="./export/outgoingreport.php?st='.$st.'&et='.$et.'&pid='.$pid.'&did='.$did.'&type=csv">Download</a>]
					</td>
				</tr> 
				<tr>
					<td colspan="2">
