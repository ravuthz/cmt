...
<script language="javascript" type="text/javascript">
	...
	function showReport(){
			...
			where = debtor.stl.value;				
					...
					{			
						url = "./php/lately_paid_no_action.php?&cid="+cid+"&w="+where;
					}
					else if (debtor.selService.options[debtor.selService.selectedIndex].value=="ISP")
					{
						url = "./php/lately_paid_isp_no_action.php?&cid="+cid+"&w="+where;
					}
					else
					{
						url = "./php/lately_paid_ll_no_action.php?&cid="+cid+"&w="+where;
					}
