		...
		*/
		...
		private function GetDetailReportBodyQS()
		{
			$strQuery = "Declare @DecPlace int\r\n".
						...
						"isnull((Select sum(isnull(Amount,0)) from tblBillingSummaryTmp where InvoiceID=ci.InvoiceID and BillItemID=29),0)+isnull((Select sum(isnull(Amount,0)) from tblCustomerInvoiceDetail where InvoiceID=ci.InvoiceID and BillItemID=29),0) AdditionalMailAmount,\r\n".
						...
						"Round(isnull(ibu.OverageChargeAmount,0),@DecPlace) OvChAmount,\r\n".
						"isnull((Select sum(isnull(Amount,0)) from isp_province.dbo.tblBillingSummaryTmp where InvoiceID=ci.InvoiceID and BillItemID=29),0)+isnull((Select sum(isnull(Amount,0)) from isp_province.dbo.tblCustomerInvoiceDetail where InvoiceID=ci.InvoiceID and BillItemID=29),0) AdditionalMailAmount,\r\n".
						"ci.NetAmount SubTotal, ci.VatAmount VAT,ci.InvoiceAmount TotalAmount,cust.Telephone,\r\n".
						...
						"Round(isnull(ibu.OverageChargeAmount,0),@DecPlace) OvChAmount,\r\n".
						"(Select sum(isnull(Amount,0)) from isp_province.dbo.tblBillingSummaryTmp where InvoiceID=ci.InvoiceID and BillItemID=29) AdditionalMailAmount,\r\n".
						"ci.NetAmount SubTotal, ci.VatAmount VAT,ci.InvoiceAmount TotalAmount,cust.Telephone,\r\n".
