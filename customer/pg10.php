...
<?php
	...
	$sql = "select cu.CustName, ct.CustTypeID, ct.CustTypeName, cu.VATNumber, cu.IsVATException, cu.RegisteredDate, 
										...
										<td valign="top" colspan="2">
											<table border="1" cellpadding="4" cellspacing="0" width="100%" height="100%" class="formbody" bordercolor="#aaaaaa" style="border-collapse:collapse">
												...
												<tr>
													...
													<td align="left" colspan="3"><b><?php print $VATNumber; ?></b></td>
												</tr>
												<tr>
