...
<?php
	...
	if(!empty($smt) && isset($smt) && ($smt == "savepg18")){
		...
		$sql = "INSERT INTO tblCustContact(CustID, ContactName, Salutation, DOB, Address, KhanID, SangkatID, CityID, 
												CountryID, NationalityID, OccupationID, Phone, Email, IdentityMode, IdentityData, SignupDate)
									VALUES($CustomerID, '".$txtContactName."', '".$selSalutation."', '".$txtDOB."', '".$txtAddress."',
