...
<script language="javascript" type="text/javascript">
	...
	function showReport(){
		...
		loading = "<table width='100%' height='100%' border=0 cellspacing=0 cellpadding=100><tr><td align=center><p><img src='./images/loading.gif' border=0><br><b>Please wait a moment...</b></p></td></tr></table>";
				...
				url = "./php/ajax_openinvoice_report.php?cid="+cid+"&ct="+ct+"&where="+where+"&mt=" + new Date().getTime();		
				window.open(url);
	...
	function showReport1(){
		...
		sid = fcloseinvoice.sid2.options[fcloseinvoice.sid2.selectedIndex].value;
		if((st == "") || (et == "")){
	...
	loading = "<table width='100%' height='100%' border=0 cellspacing=0 cellpadding=100><tr><td align=center><p><img src='./images/loading.gif' border=0><br><b>Please wait a moment...</b></p></td></tr></table>";
			document.getElementById("d-result").innerHTML = loading;
			url = "./php/ajax_closeinvoice.php?st="+st+"&et="+et+"&sid="+sid+"&mt=" + new Date().getTime();			
			getTranDetail(url, "d-result");
		}
	}
	...
	<tr>		
		<td valign="top" align="left">
			<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left">
				<tr>
					<td width="244" align="left" class="formtitle"><b>OPEN INVOICE REPORT</b></td>
				</tr> 
				<tr>
					<td colspan="2">
