...
<script language="JavaScript" src="./javascript/ajax_detailt.js"></script>
<script language="javascript" type="text/javascript">
	...
	function showDetail(){	
			...
			url = detail.webroot.value+"PrintingDetailbyAccID.aspx?ServiceID=2&TrackID="+aid+"&BillEndDate="+cid+"&CallType="+calltype.substring(1)+"&mt="+ new Date().getTime();
			window.open(url);	
	}
	...
	function ValidTextSearch(){
		...
		{
			location(7, detail.txtSearchText.value, "selAcc");
		}
		else if(detail.rblStyle[1].checked)
		{
			location(8, detail.txtSearchText.value, "selAcc");
		}
		else if(detail.rblStyle[2].checked)
		{
			location(9, detail.txtSearchText.value, "selAcc");
		}
		else if(detail.rblStyle[3].checked)
		{
			location(10, detail.txtSearchText.value, "selAcc");
		}
