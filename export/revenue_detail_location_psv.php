<?php
	...
	$filename = "Summary_Revenue_by_Province";
			...
			$retOut = '				
				...
				<tr>
					<td colspan=2 align="left" class="formtitle">
						Summary Revenue by Province<br />
						Location: '.$City.'<br />
						Cycle date: '.FormatDate($cid, 3).'<br />
						Service Name: '.$sst.'
					</td>
					<td colspan=6 valign="bottom" align="right" class="formtitle">
	...
	$sql = " select CustID, AccID, SubscriptionName, Telephone, InvoiceID, TotalHour, ChargeHour, 
			...
			InvoiceAmount - CycleUnpaidAmount 'Paid', CycleUnpaidAmount 'Unpaid' ,ServiceID, ServiceName,InvoiceType
