...
<script language="javascript" type="text/javascript">
	function showReport(){
		st = fBardAccount.st.value;
		et = fBardAccount.et.value;
		if((st == "") || (et == "")){
	...
	loading = "<table width='100%' height='100%' border=0 cellspacing=0 cellpadding=100><tr><td align=center><p><img src='./images/loading.gif' border=0><br><b>Please wait a moment...</b></p></td></tr></table>";
			document.getElementById("d-bardaccount").innerHTML = loading;
			url = "./php/ajax_baraccount.php?st="+st+"&et="+et;
			getTranDetail(url, "d-bardaccount");
		}
	}
</script>
	...
	<tr>		
		<td valign="top" align="left">
			<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left">
				<tr>
					<td align="left" class="formtitle"><b>BARRED ACCOUNTS REPORT</b></td>
					<td align="right"></td>
				</tr> 
				<tr>
					<td colspan="2">
						<form name="fBardAccount" onSubmit="showReport(); return false;">
