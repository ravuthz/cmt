...
function getpackage(check){
	...
	function viewreport(index){
		...
		if(index ==1){
			...
			url = "./php/ajax_acc_nodeposit.php?where="+where+"&mt="+new Date().getTime();
			getTranDetail(url, "d-result");
		}else{
			
			url = "./export/acc_no_deposit.php?where="+where+"&mt="+new Date().getTime();
			window.location = url;
		}
	}
</script>
	...
	<tr>		
		<td valign="top" align="left">
			<table border="0" cellpadding="2" cellspacing="0" class="formbg" align="left" >
				<tr>
					<td align="left" class="formtitle"><b>ACCOUNT WITH NO DEPOSIT REPORT</b></td>
					<td align="right"></td>
				</tr> 
				<tr>
					<td colspan="2">
