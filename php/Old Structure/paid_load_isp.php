...
<?php
	...
	//require_once("lately_paid_isp_af_delay.php");	
	...
	include("lately_paid_isp_af_delay.php");
	...
	$sql = "select * from dbo.fn_latelypaid_1m_isp_request('".$cid."','".$where."') where status<>'Closed' order by ty,exception desc,remark desc ,state,del,pdate,phone,CustName";
