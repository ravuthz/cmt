			...
			if($mydb->sql_query($sql)){
				if($ServiceID == 4){
					...
					$sql = "INSERT INTO tblJobAcctStatus(AccID, CurrentStatusID, NewStatusID, SubmitDate, EffectiveDate, Comment, 
							...
							VALUES($AccountID, $cst, $cmd, '".$today."', '".formatDate($txtChangeOn, 8)."','".$comment."', 0, 1, ".
							$incoming.", ".$outgoing.", ".$international.",	".$incomingloc.", ".$incomingnat.", ".$outgoingloc.", ".
							$outgoingnat.", ".$other.", 1, 1, '".$today."', 1, '".$today."','".$comment."')";
