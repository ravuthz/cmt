...
//$sql = "select distinct * from dbo.fn_latelypaid_1m_request_u('$cid','$where') order by  remark desc,exception,state,exc desc,del,pdate,phone,CustName";

$sql = "select * from __drop1";
...
//print $sql;
	...
	$Print=date('Y-m-d H:i:s',strtotime('previous hour'));
