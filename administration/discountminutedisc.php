		...
		if($op=="add"){
			...
			if(CheckDestinationDiscount($cmbRecChargeID,$txtDescription,true,$desdiscid)){
				...
				$sql.= "UPDATE tblEventDiscDestSpecific SET RecChargeID='$cmbRecChargeID', Description='$txtDescription' Where DiscDestID='".intval($desdiscid)."'";
					...
					while($i<$numrecord){
					    $txtMinuteAmount=intval($_POST["txtMinuteAmount".$i];
						$DiscRate=doubleval($_POST["txtRate".$i]);
...
<table border="0" cellpadding="2" cellspacing="0" class="formbg"  width="440">
			   <tr>
				 <td width="436" height="18" align="left" class="formtitle"><strong>Destination Specific Setup </strong></td>
			   </tr>
			   <tr>
				 <td valign="top">
				   <table border="0" cellpadding="2" cellspacing="0" width="100%" height="100%" bgcolor="#feeac2">
					 ...
					 <tr >
						...
						<?php }?>
						</select><img src="./images/required.gif" border="0" /></td>
					</tr>	
					<tr>
						<td align="left" style="padding-left:10" >Description:</td>
				 	  <td align="left" colspan="5"><input type="text" name="txtDescription" value="<?php echo $txtDescription;?>" size="40" />
					...
					<tr>
					 ...
					 <tr>
					   ...
					   <td width="30%" align="center"><strong>Is Bigger than </strong></td>
					   <td width="29%" align="center"><strong>Minute(s)</strong></td>
					  <td width="34%" align="center"><strong>Discount</strong></td>
					  </tr>
					<?php 
					...
					$newindex=0;
					while ($k<$numrecord) {
						$txtMinuteAmount=$_POST["txtMinuteAmount".$k];
					...
					<tr>
					  ...
					  <td align="center">&gt;</td>
					  <td  align="center">
					    <input type="text" name="txtMinuteAmount<?php echo $newindex?>" value="<?php echo $txtMinuteAmount;?>" size="6"  />				      </td>
					  <td  align="center">
				     ...
				     <?php
					  ...
					  <td align="center"><input type="checkbox" name="chSel<?php echo $newindex?>" value="1"></td>
					  <td align="center">&gt;</td>
					  <td  align="center"><input type="text" name="txtMinuteAmount<?php echo $newindex?>" value="<?php echo $txtMinuteAmount;?>" size="6"></td>
					  <td  align="center">
					    <input type="text" name="txtRate<?php echo $newindex?>" value="<?php echo  $txtRate;?>"  size="4" />				      </td>
					  </tr>
