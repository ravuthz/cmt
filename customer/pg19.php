...
<?php
	...
	if(!empty($smt) && isset($smt) && ($smt == "savepg19")){
		...
		$sql = "INSERT INTO tblCustGuarrantor(CustID, GuarrantorName, Salutation, DOB, Address, KhanID, SangkatID, CityID, 
												CountryID, NationalityID, OccupationID, Phone, Email, IdentityMode, IdentityData, SignupDate)
									VALUES($CustomerID, '".$txtGuarratorName."', '".$selSalutation."', '".$txtDOB."', '".$txtAddress."',
